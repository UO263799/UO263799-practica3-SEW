...
class Meteo {
    constructor(){
        this.apikey = "909b21d1b80f8cfdabe0f7743686bdf5";
        this.tipo = "&mode=xml";
    ...
    cargarDatos(city){
        ...
        $.ajax({
            ...
            success: function(datos){
                    $(".datos").text((new XMLSerializer()).serializeToString(datos));
    ...
    verXML(city){
        $("h3").empty();
        this.crearElemento("h3","Datos extraidos de <a href='http://openweathermap.org'>OpenWeatherMap</a>","p");          
